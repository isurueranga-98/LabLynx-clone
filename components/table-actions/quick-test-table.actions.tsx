...
import { deleteQuickTestAction } from "@/lib/actions/quick-test/delete-quick-test.action";
...
export const QuickTestTableActions = ({
  ...
  const handleDelete = async () => {
    await deleteQuickTestAction(row.original.id);
  };
      ...
      <DropdownMenuContent align="end">
        ...
        <DropdownMenuItem>
          <Link href={`/enter-results?${rowQuery}`}>
            <Button variant="link">Enter Results</Button>
          </Link>
        </DropdownMenuItem>
